      ...
      <div className="relative bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div className="px-8 pb-8">
          <div className="relative -mt-12 mb-4 flex justify-between items-end">
            <img
              src={user?.image || `https://ui-avatars.com/api/?name=${encodeURIComponent((user?.firstName || '') + ' ' + (user?.lastName || ''))}&background=6366f1&color=fff&size=128`}
              alt="Avatar"
        ...
        <div className="flex items-center justify-between py-2">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Receive system updates and activity logs</p>
            </div>
          </div>
          <button
